...
- **2026-07-27:** [P1H-T7](tickets/P1H-T7-canon-and-hygiene-sweep.md) resolved. Removed `docs/research/` from `.gitignore` (anchored `/research/`), fixed model ID casing to `gemma-4-31b-it` in `docs/research/T1-google-ai-studio-sdk-findings.md`, replaced `asyncio_to_thread` shim with stdlib `asyncio.to_thread` in `gemma.py`, documented all 4 env vars in `README.md`, updated P2-T4 label to `afk`, and tracked research canon in git.
- **2026-07-27:** **ALL Phase 1 Hardening tickets (P1H-T1 through P1H-T7) are now resolved.** Trust floor established for Phase 2 Verifier.
